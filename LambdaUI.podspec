# coding: utf-8
#
#  Be sure to run `pod spec lint LambdaUI.podspec' to ensure this is a
...
Event handling with lambda functioncs and Grand Central Dispatch ( GCD ) asynchronous ( async ) support
  ...
  # Or just: s.author    = "Mislav Javor"
  # s.authors            = { "Mislav Javor" => "mislav.javor@outlook.com" }
  # s.social_media_url   = "http://twitter.com/Mislav Javor"
